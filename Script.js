...
function displayCompanies(userLocation) {
    ...
    companies.forEach((company) => {
        ...
        card.innerHTML = `
            ...
            <img src="/Users/t-daichi/Documents/Webアプリ/TEHAI_rowdate/備考.jpg" alt="備考"><p>⚪︎備考: ${company.memo}</p>            
            <img src="/Users/t-daichi/Documents/Webアプリ/TEHAI_rowdate/移動時間.jpg" alt="移動時間"><p>⚪︎移動時間: ${company.duration || "計算中..."}</p>
            <img src="/Users/t-daichi/Documents/Webアプリ/TEHAI_rowdate/契約.jpg" alt="契約"><p>⚪︎契約書: ${company.contract}</p>            
